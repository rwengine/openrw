...
Animator::Animator(Model* model, Skeleton* skeleton) : model(model), skeleton(skeleton) {}
...
void Animator::tick(float dt)
{
  ...
  for (auto& p : blendFrames) {
    ...
    fd.a.translation = model->frames[p.first]->getDefaultTranslation() + p.second.translation;
