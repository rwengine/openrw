...
ScreenTextEntry ScreenTextEntry::makeBig(const std::string& id, const std::string& str, int style,
                                         int durationMS)
{
  switch (style) {
    // Color: Blue
    ...
    case 1:
      return {str, {320.f, 252.f}, 1, 50, {2, 0, 0, 0}, {58, 119, 133}, 1, durationMS, 0, 600, id};
    ...
    case 2:
      return {str, {620.f, 380.f}, 1, 30, {2, 3, 0, 0}, {214, 171, 9}, 2, durationMS, 0, 600, id};
    ...
    case 6:
      return {str, {320.f, 240.f}, 2, 50, {2, 2, 0, 0}, {152, 89, 39}, 1, durationMS, 0, 600, id};
...
ScreenTextEntry ScreenTextEntry::makeHighPriority(const std::string& id, const std::string& str,
                                                  int durationMS)
{
  // Color: ?
  // Font: Arial
  ...
  return {str, {320.f, 420.f}, 2, 18, {1, 0, 0, 0}, {255, 255, 255}, 1, durationMS, 0, 50, id};
}

ScreenTextEntry ScreenTextEntry::makeHelp(const std::string& id, const std::string& str)
{
  return {str, {20.f, 20.f}, 2, 18, {0, 0, 0, 255}, {255, 255, 255}, 0, 5000, 0, 35, id};
}
