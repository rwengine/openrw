...
{
public:
  ObjectRenderer(GameWorld* world, const ViewCamera& camera, float renderAlpha, GLuint errorTexture)
...
private:
  ...
  void renderItem(InventoryItem* item, const glm::mat4& modelMatrix, RenderList& outList);
  void renderWheel(VehicleObject* vehicle, Model* model, const glm::mat4& matrix,
  ...
  void renderGeometry(Model* model, size_t g, const glm::mat4& modelMatrix, float opacity,
