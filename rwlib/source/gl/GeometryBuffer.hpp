 ...
 */
enum AttributeSemantic { ATRS_Position, ATRS_Normal, ATRS_Colour, ATRS_TexCoord };
...
public:
  ...
  GLuint getVBOName() const { return vbo; }

  GLsizei getCount() const { return num; }
  ...
  AttributeList& getDataAttributes() { return attributes; }
};
