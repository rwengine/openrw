...
int IMGArchiveModel::rowCount(const QModelIndex& parent) const { return archive.getAssetCount(); }

int IMGArchiveModel::columnCount(const QModelIndex& parent) const { return 2; }
